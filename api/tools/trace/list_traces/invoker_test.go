...
const (
	...
	workspaceId = "3"
	token       = "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJ1c2VySWQiOiIxIiwiYWNjb3VudCI6ImFkbWluIiwiZXhwIjoxNzY1NTMxODk1LCJpYXQiOjE3NjU1MjgyOTV9.B-PE-UwISga7Sb0gfJhqygpXuzNkAWcXnQwSrDeOueI"
)
